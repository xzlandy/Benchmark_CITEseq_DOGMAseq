...
cowplot::ggsave2(cowplot::plot_grid(
  pRNA, nrow = 1
), file = "../plots/all_QC.pdf", width = 1, height = 1.5)
...
cowplot::ggsave2(cowplot::plot_grid(
  pRNA, nrow = 1
), file = "../plots/all_QC_split.pdf", width = 3, height = 1.5)
...
cowplot::ggsave2(cowplot::plot_grid(
  pRNA, nrow = 1
), file = "../plots/all_QC_split_sample.pdf", width = 2, height = 2)
...
# <chr> <chr>                        <dbl> <int>
# 1 CITE  SB775372                     2322.  6902
# 2 CITE  SB775393                     2340   5697
