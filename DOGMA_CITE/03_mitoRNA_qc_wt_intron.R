...
cowplot::ggsave2(cowplot::plot_grid(
  pMitoRNA
), file = "../plots/mitoRNApct_QC_wt_intron.pdf", width = 1, height = 1.5)
...
cowplot::ggsave2(cowplot::plot_grid(
  pMitoRNA
), file = "../plots/mitoRNApct_QC_split_wt_intron.pdf", width = 3, height = 1.5)
...
cowplot::ggsave2(cowplot::plot_grid(
  pMitoRNA
), file = "../plots/mitoRNApct_QC_split_sample_wt_intron.pdf", width = 2, height = 2)
...
# <chr>    <chr>            <dbl>
# 1 SB775372 CITE              4.44
# 2 SB775372 DIG               7.04
# 3 SB775393 CITE              5.39
# 4 SB775393 DIG               8.30