...
saveRDS(ave.rogue.res.df, file = '../output/dig_rna_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/dig_adt_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/dig_atac_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/dig_wnn_rogue.RDS')
write.csv(data@meta.data, file = '../output/dig_rogue_meta.csv')