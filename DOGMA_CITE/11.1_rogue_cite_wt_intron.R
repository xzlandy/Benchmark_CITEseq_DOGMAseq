...
saveRDS(ave.rogue.res.df, file = '../output/cite_rna_rogue_wt_intron.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/cite_adt_rogue_wt_intron.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/cite_wnn_rogue_wt_intron.RDS')
write.csv(data@meta.data, file = '../output/cite_rogue_meta_wt_intron.csv')