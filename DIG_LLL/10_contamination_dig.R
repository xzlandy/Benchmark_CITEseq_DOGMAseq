...
raw <- Read10X_h5('../../../Duerr_20210419_DOGMAseq_DIG/outs/raw_feature_bc_matrix.h5')
...
filtered <- Read10X_h5('../../../Duerr_20210419_DOGMAseq_DIG/outs/filtered_feature_bc_matrix.h5')
...
saveRDS(decontx, file = '../output/dig_decontx.RDS')
