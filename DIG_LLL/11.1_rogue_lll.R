...
saveRDS(ave.rogue.res.df, file = '../output/lll_rna_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/lll_adt_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/lll_atac_rogue.RDS')
...
saveRDS(ave.rogue.res.df, file = '../output/lll_wnn_rogue.RDS')
write.csv(data@meta.data, file = '../output/lll_rogue_meta.csv')